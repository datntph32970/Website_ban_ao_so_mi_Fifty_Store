        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HoaDons_NhanViens_id_nguoi_sua",
                        column: x => x.id_nguoi_sua,
                        principalTable: "NhanViens",
                        principalColumn: "id_nhan_vien",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HoaDons_NhanViens_id_nguoi_tao",
                        column: x => x.id_nguoi_tao,
                        principalTable: "NhanViens",
                        principalColumn: "id_nhan_vien",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_kich_co = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    id_mau_sac = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    id_giam_gia = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SanPhamChiTiets", x => x.id_san_pham_chi_tiet);
                    table.ForeignKey(
                        name: "FK_SanPhamChiTiets_GiamGias_id_giam_gia",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nguoiSuaid_nhan_vien = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HoaDonChiTiets_NhanViens_nguoiSuaid_nhan_vien",
                        column: x => x.nguoiSuaid_nhan_vien,
                        principalTable: "NhanViens",
                        principalColumn: "id_nhan_vien");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HoaDonChiTiets_nguoiSuaid_nhan_vien",
                table: "HoaDonChiTiets",
                column: "nguoiSuaid_nhan_vien");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HoaDons_id_nguoi_sua",
                table: "HoaDons",
                column: "id_nguoi_sua");

            migrationBuilder.CreateIndex(
                name: "IX_HoaDons_id_nguoi_tao",
                table: "HoaDons",
                column: "id_nguoi_tao");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SanPhamChiTiets_id_giam_gia",
